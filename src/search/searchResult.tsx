...
const SearchResult = ({ carouselList }: Props) => {
  ...
  const showRightButton = currIndex < carouselList.length + 4;

  useEffect(() => {
    setCurrIndex(1); // carouselList가 변경될 때마다 currIndex를 1로 설정
  }, [carouselList]); // carouselList의 변경을 감지하기 위한 의존성 배열
